# Kaggriculture submission — committed-circuit coordinator (self-contained).
# Auto-built from sim/coordinator.py; the engine internals it needs (quadrant_of,
# CROPS, get) are inlined so this file has no dependency on engine private modules.
...
class _K:
    ...
    _quadrant_of = staticmethod(_quadrant_of)
    CROPS = CROPS
K = _K
